...
| `/drydock`         | Periodic deep compaction of the home's accumulated knowledge and files: consolidate learnings to their essential rules, graduate recurring procedures, interview the captain on which projects to continue, and prune stale files - every destructive step proposed and confirmed first |
